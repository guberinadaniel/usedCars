...
namespace Drupal\featured_cars_block\Plugin\Block;
use Drupal\file\Entity\File;
use Drupal\Core\Block\BlockBase;

/**
 * Provides a 'featuredCarsBlock' block.
 *
 * @Block(
 *  id = "featured_cars_block",
 *  admin_label = @Translation("featured cars block"),
 * )
 */

class FeaturedCarsBlock extends BlockBase {
